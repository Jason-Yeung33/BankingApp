...
public class ReimbursementRequestController {
    ...
    public ResponseEntity createReimbursementRequest(@RequestBody ReimbursementRequest newReimbursementRequest) {
        ...
        try {
            newReimbursementRequest = reimbursementRequestService.createReimbursementRequest(newReimbursementRequest);
    ...
    @PostMapping("{id}")
    public ResponseEntity editReimbursementRequest(@RequestBody ReimbursementRequest newReimbursementRequest) {
        logger.info("ReimbursementRequestController - POST mapping for edit an existing reimbursement request");
        try {
